...
{
    public static class ERegistrationEfCoreEntityExtensionMappings
    {
        private static readonly OneTimeRunner OneTimeRunner = new OneTimeRunner();

        public static void Configure()
        {
            ERegistrationModulePropertyConfigurator.Configure();
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * ERegistrationDomainObjectExtensions class.
                 *
                 * Example:
                 *
