...
namespace ARB.ERegistration.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ERegistrationDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ERegistrationEfCoreEntityExtensionMappings to extend the IdentityUser entity
