...
namespace ARB.ERegistration.ObjectExtending
{
    public static class ERegistrationDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the ERegistrationEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
