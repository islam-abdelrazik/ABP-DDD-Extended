...
{
    [DbContext(typeof(ERegistrationMigrationsDbContext))]
    partial class ERegistrationMigrationsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ARB.ERegistration.BankAccounts.BankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid>("RetailCustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ARB.ERegistration.RetailCustomers.RetailCustomer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EReg.RetailCustomers");
                });
            ...
            modelBuilder.Entity("ARB.ERegistration.BankAccounts.BankAccount", b =>
                {
                    b.HasOne("ARB.ERegistration.RetailCustomers.RetailCustomer", null)
            ...
            modelBuilder.Entity("ARB.ERegistration.RetailCustomers.RetailCustomer", b =>
                {
                    b.OwnsOne("ARB.ERegistration.Card.ATMCard", "ATMCard", b1 =>
                        {
                            b1.Property<Guid>("RetailCustomerId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("RetailCustomerId");

                            b1.ToTable("EReg.RetailCustomers");
