...
using ARB.ERegistration.MultiTenancy;
...
{
    [DependsOn(
        typeof(ERegistrationHttpApiModule),
    ...
    public class ERegistrationHttpApiHostModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
        {
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<ERegistrationDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}ARB.ERegistration.Domain.Shared"));
        ...
        private void ConfigureConventionalControllers()
        {
            ...
            {
                options.ConventionalControllers.Create(typeof(ERegistrationApplicationModule).Assembly);
            });
        }
        ...
        private void ConfigureAuthentication(ServiceConfigurationContext context, IConfiguration configuration)
        {
            ...
            context.Services.AddTokenAuthentication(configuration);
        ...
        private static void ConfigureSwaggerServices(ServiceConfigurationContext context)
        {
            context.Services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc("v1", new OpenApiInfo {Title = "ERegistration API", Version = "v1"});
        ...
        public override void OnApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "ERegistration API");
            });
